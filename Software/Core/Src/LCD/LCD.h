...
#define LCD_WRITE		HAL_GPIO_WritePin(R_W_GPIO_Port, R_W_Pin, GPIO_PIN_RESET)
#define LCD_READ		HAL_GPIO_WritePin(R_W_GPIO_Port, R_W_Pin, GPIO_PIN_SET)

#define LCD_ENABLE_ON	HAL_GPIO_WritePin(E_GPIO_Port, E_Pin, GPIO_PIN_SET)
#define LCD_ENABLE_OFF 	HAL_GPIO_WritePin(E_GPIO_Port, E_Pin, GPIO_PIN_RESET)
...
public:
	...
	LCD();
	void initLCD(void);
	bool LCDWriteData(char* data,uint8_t size);
