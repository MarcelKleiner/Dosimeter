...
F 1 "100p" V 3889 2250 50  0000 C CNN
F 2 "Capacitor_THT:C_Axial_L3.8mm_D2.6mm_P12.50mm_Horizontal" H 4088 2100 50  0001 C CNN
...
U 1 1 5F48F410
P 5300 3300
F 0 "RV1" H 5231 3346 50  0000 R CNN
F 1 "R_POT" H 5231 3255 50  0000 R CNN
F 2 "Potentiometer_THT:Potentiometer_Vishay_T73YP_Vertical" H 5300 3300 50  0001 C CNN
...
U 1 1 5F4900ED
P 5300 3600
F 0 "#PWR0112" H 5300 3350 50  0001 C CNN
...
U 1 1 5F4657F1
P 4050 1350
F 0 "C6" V 3798 1350 50  0000 C CNN
F 1 "100n" V 3889 1350 50  0000 C CNN
...
U 1 1 5F4666EF
P 5350 1350
F 0 "C9" V 5098 1350 50  0000 C CNN
F 1 "100n" V 5189 1350 50  0000 C CNN
...
U 1 1 5F46C172
P 4650 1250
F 0 "U3" H 4650 1575 50  0000 C CNN
F 1 "NCP718BSN330T1G" H 4650 1484 50  0000 C CNN
F 2 "Package_TO_SOT_SMD:TSOT-23-5" H 4400 1250 50  0001 C CNN
F 3 "https://www.mouser.ch/datasheet/2/308/NCP718-D-1224359.pdf" H 4400 1250 50  0001 C CNN
F 4 "863-NCP718BSN330T1G" H 4650 1250 50  0001 C CNN "Mouser Nr."
F 5 "NCP718BSN330T1G" H 4650 1250 50  0001 C CNN "Hersteller Nr."
	1    4650 1250
	1    0    0    -1  
$EndComp
Wire Wire Line
...
U 1 1 5F47DF7C
P 5350 1000
F 0 "#PWR0120" H 5350 850 50  0001 C CNN
...
U 1 1 5F4859A1
P 1400 1300
F 0 "J2" H 1318 975 50  0000 C CNN
F 1 "Vin +12" H 1318 1066 50  0000 C CNN
F 2 "MK_Footprints:TerminalBlock_Phoenix_MPT-0,5-2-2.54_1x02_P2.54mm_Horizontal" H 1400 1300 50  0001 C CNN
...
U 1 1 5F4859A8
P 2500 1600
F 0 "#PWR0122" H 2500 1350 50  0001 C CNN
...
U 1 1 5F51A8DE
P 3750 1150
F 0 "D1" V 3704 1229 50  0000 L CNN
F 1 "D" V 3795 1229 50  0000 L CNN
F 2 "Diode_SMD:D_0603_1608Metric" H 3750 1150 50  0001 C CNN
...
U 1 1 5F529DD5
P 3550 1000
F 0 "#PWR0132" H 3550 850 50  0001 C CNN
...
DB3
$Comp
L Dosimeter-rescue:LCD_NHD-0108CZ-MK_LCD U6
U 1 1 5F5C5758
P 8850 5300
...
F 1 "+6V" H 2565 1123 50  0000 C CNN
...
F 1 "+6V" H 4065 1173 50  0000 C CNN
...
U 1 1 5F4E7C7D
P 1950 1250
F 0 "BT1" H 2058 1296 50  0000 L CNN
F 1 "Battery" H 2058 1205 50  0000 L CNN
F 2 "MK_Footprints:BatteryHolder_Keystone_2477_4xAA" V 1950 1310 50  0001 C CNN
F 3 "~" V 1950 1310 50  0001 C CNN
	1    1950 1250
	1    0    0    -1  
$EndComp
Wire Wire Line
...
Wire Wire Line
	1950 1500 1700 1500
Text GLabel 5950 4950 2    50   BiDi ~ 0
SWDIO
Text GLabel 5950 4850 2    50   Output ~ 0
SWCLK
$Comp
...
F 1 "+3.3V" H 5965 4823 50  0000 C CNN
...
U 1 1 5F5818FE
P 5950 5150
F 0 "#PWR0115" H 5950 4900 50  0001 C CNN
...
Wire Wire Line
	5850 5050 5950 5050
Text GLabel 4100 6550 2    50   BiDi ~ 0
SWDIO
...
U 1 1 5F607EBF
P 5650 4850
F 0 "J8" H 5758 5131 50  0000 C CNN
F 1 "Conn_01x04_Male" H 5758 5040 50  0000 C CNN
F 2 "Connector_PinHeader_2.54mm:PinHeader_1x04_P2.54mm_Vertical" H 5650 4850 50  0001 C CNN
...
F 1 "+6V" H 5315 3223 50  0000 C CNN
...
U 1 1 5F522CE9
P 2250 1000
F 0 "SW3" H 2250 1235 50  0000 C CNN
F 1 "SW_SPST" H 2250 1144 50  0000 C CNN
F 2 "Button_Switch_SMD:SW_SPDT_PCM12" H 2250 1000 50  0001 C CNN
